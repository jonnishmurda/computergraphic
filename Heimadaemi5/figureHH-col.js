...
var runningSpeed = 0.005;
var runningAngle = 50;

function animateRunning() {
    var t = Date.now() * runningSpeed;

    theta[leftUpperLegId] = runningAngle * Math.sin(t);
    theta[rightUpperLegId] = runningAngle * Math.sin(t + Math.PI);

    theta[leftUpperArmId] = runningAngle * Math.sin(t + Math.PI);
    theta[rightUpperArmId] = runningAngle * Math.sin(t);
